 ...
 * @author ANURUDDHA
 */
public class Invo extends javax.swing.JInternalFrame {
...
//            v.add("Default customer");
    ...
    public static void invoiceNo() {
        try {
            ...
            jTinvoice_no.setText("DSKI" + 15000001);
        }
    }
    ...
    public boolean cal() {
        ...
        if (jCCash.isSelected() && !(jCCheque.isSelected()) && !(jCCredit.isSelected())) {
            ...
            if ((cha + ca) < na) {
                ...
                jTBalance.setForeground(Color.black);
                jTBalance.setText(df.format((ca + cha) - na));
            }
    ...
    public static void printInvoice(double na, double caa, double cha, double cra, double ba) {
        try {
            ...
            JasperReport r = JasperCompileManager.compileReport("G:\\DOCUMENTS\\exploit\\PROJECTS\\DSK\\src\\reports\\invoice.jrxml");
    ...
    private void initComponents() {
        ...
        jTable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item ID", "Name", "Unit price(Rs)", "Qty", "Net amount(Rs)"
            }
        ));
