...
public class EditEmployeeDetails extends javax.swing.JInternalFrame {
    ...
    void irTabale() {
        try {
            ...
            d.setRowCount(0);
            ResultSet rs = JDBC.getdata("SELECT * FROM employee");
            while (rs.next()) {
                Vector v = new Vector();
    ...
    private void initComponents() {
        ...
        jTable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer No", "First Name", "Last Name", "Contact No", "email", "Status"
            }
        ));
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        try {
            ...
            if (status.equals("Active")) {
                JDBC.putdata("UPDATE employee SET status='Deactive' WHERE eid='" + id + "'");
                irTabale();
            } else {
                JDBC.putdata("UPDATE employee SET status='Active' WHERE eid='" + id + "'");
                irTabale();
            }
        } catch (Exception e) {
