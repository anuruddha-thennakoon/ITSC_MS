 ...
 * @author ANURUDDHA
 */
public class EditBankDetails extends javax.swing.JInternalFrame {

    /**
     * Creates new form EditBankDetails
     */
    ...
    void irTabale() {
        try {
            ...
            d.setRowCount(0);
            ResultSet rs = JDBC.getdata("SELECT * FROM bank");
            while (rs.next()) {
                Vector v = new Vector();
    ...
    private void initComponents() {
        ...
        jTable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Bank No", "Name", "Branch", "Contact No", "email", "Status"
            }
        ));
    ...
    private void jTable3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable3MouseClicked
        try {
            DefaultTableModel d = (DefaultTableModel) jTable3.getModel();
            String status = d.getValueAt(jTable3.getSelectedRow(), 5).toString();
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        try {
            ...
            if (status.equals("Active")) {
                JDBC.putdata("UPDATE bank SET status='Deactive' WHERE bid='" + id + "'");
                irTabale();
            } else {
                JDBC.putdata("UPDATE bank SET status='Active' WHERE bid='" + id + "'");
                irTabale();
            }
        } catch (Exception e) {
