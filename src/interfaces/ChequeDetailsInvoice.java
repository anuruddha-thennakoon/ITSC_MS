 ...
 * @author ANURUDDHA
 */
public class ChequeDetailsInvoice extends javax.swing.JInternalFrame {

    /**
     * Creates new form ChequeDetails
     */
    public ChequeDetailsInvoice() {
        initComponents();
        bankCombo();
    }
    ...
    private void jButton22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton22ActionPerformed
        try {
            if (jTname.getText().isEmpty()) {
                ...
                while (rs.next()) {
                    Invoice.bank = rs.getString("bid");
                }
                Invoice.cheque_no = jTname.getText();
                Invoice.date = date;
                ...
                JDBC.putdata("INSERT INTO cheque_info VALUES(0,"
                        ...
                        + "'" + Invoice.jTinvoice_no.getText().trim() + "',"
                        + "'Received',"
                        + "'Customer')");
